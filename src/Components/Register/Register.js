    ...
    return (
        <div className="">
            <div class="w-full max-w-xs mx-auto">
                <h1 className="text-center mt-4 text-2xl font-bold mt-10 text-red-500">Please Login</h1>
            ...
            <div className="flex ">
                ...
                <NavLink className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline mx-auto mb-7" to="/login">Already Login?</NavLink>
            </div>
        </div>
    );
};
